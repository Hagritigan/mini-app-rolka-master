    ...
    <Panel id={id}>
        ...
        <Group>
            <Div>
                ...
                <ul class="listing">
                    <li><span class="l">Юнга</span></li>
                    <li><span class="l">Матрос</span></li>
                    <li><span class="l">Матрос 1-го класса</span></li>
                    <li><span class="l">Капрал</span></li>
                    <li><span class="l">Главный сержант</span></li>
                    <li><span class="l">Мичман</span></li>
                </ul>
                ...
                <div class="desktop-only">
                    <table>
                        ...
                        <tbody>
                            ...
                            <ul class="listing">
                            <li><span class="l">+1 способность</span></li>
                            </ul></td>
                            <td>3400 ОЗ</td>
                            <td>110</td>
                            </tr>
                ...
                <ul class="listing">
                    <li><span class="l">Пират без награды - 200 ОЗ</span></li>
                    <li><span class="l">Пират с наградой 30кк и меньше - 300 ОЗ</span></li>
                    <li><span class="l">Пират с наградой от 30кк и до 70кк - 400 ОЗ</span></li>
                    <li><span class="l">Пират с наградой от 70кк и до 150кк - 500 ОЗ</span></li>
                    <li><span class="l">Пират с наградой от 150кк и до 300кк - 700 ОЗ</span></li>
                </ul>
                ...
                <ul class="listing">
                <li><span class="l">Организация операции по освобождению острова от пиратов/РА - 1000 ОЗ</span></li>
                <li><span class="l">Организация операции по поимке Сверхнового(игрок либо босс из админских) - 1300 ОЗ</span></li>
                <li><span class="l">Организация операции по поимке бывшего Шичибукая - 1500 ОЗ</span></li>
                <li><span class="l">Организация операции по поимке особо опасных деятелей теневого мира - 1100 ОЗ</span></li>
                </ul>
                ...
                <ul class="listing">
                    <li><span class="l">В зависимости от степени содействия и сложности задания - от 300 ОЗ</span></li>
                </ul>
                ...
                <ul class="listing">
                    <li><span class="l">Пропуск собрания без уважительной причины - 500 ОЗ</span></li>
                    <li><span class="l">Провал задания - от 500 до 1000 ОЗ</span></li>
                    <li><span class="l">Провал операции - от 1000 ОЗ до 1500 ОЗ</span></li>
                    <li><span class="l">Потери среди подчиненных вам дозорных (имеются ввиду ваши личные боты и общие боты) - от 500 ОЗ до 2000 ОЗ</span></li>
                    <li><span class="l">Отказ подчиняться выше стоящему дозорному - 1000 ОЗ</span></li>
                </ul>
                ...
                <ul class="listing">
                    <li><span class="l">Корабли</span></li>
                </ul>
                ...
                <ul class="listing">
                    <li><span class="l">Оружие</span></li>
                </ul>
                ...
                Контр-Адмиралы
                <ul class="listing">
                <li><span class="l">Контр-Адмирал Джунозе (Штаб Дозора Вест-Блю)</span></li>
                <li><span class="l">Контр-Адмирал Ламия (Штаб Дозора Ист-Блю)</span></li>
                <li><span class="l">Контр-Адмирал Горр (Штаб Дозора Норд-Блю)</span></li>
                <li><span class="l">Контр-Адмирал Эвереска (Штаб Дозора Саус-Блю)</span></li>
                </ul>
                Вице-Адмиралы
                <ul class="listing">
                <li><span class="l">Вице-Адмирал Маркус Фокс (без штаба)</span></li>
                <li><span class="l">Вице-адмирал Цуру (Мариджоа)</span></li>
                <li><span class="l">Вице-адмирал Гигант Джон (Маринфорд)</span></li>
                <li><span class="l">Вице-адмирал Комил (G-2)</span></li>
                <li><span class="l">Вице-адмирал Момонга (Маринфорд)</span></li>
                <li><span class="l">Вице-адмирал Онигумо (Маринфорд)</span></li>
                <li><span class="l">Вице-адмирал Доберман (G-2)</span></li>
                <li><span class="l">Вице-адмирал Стробери (G-3)</span></li>
                <li><span class="l">Вице-адмирал Ямакадзи (G-4)</span></li>
                <li><span class="l">Вице-адмирал Ронс (Маринфорд)</span></li>
                <li><span class="l">Вице-адмирал Стеинлесс (Мариджоа)</span></li>
                <li><span class="l">Вице-адмирал Мозамбия (Мариджоа)</span></li>
                <li><span class="l">Вице-адмирал Кансер (База дозора в НМ)</span></li>
                <li><span class="l">Вице-адмирал Далматин (Маринфорд)</span></li>
                <li><span class="l">Вице-адмирал Бастилия (База дозора в НМ)</span></li>
                </ul>
                Адмиралы
                <ul class="listing">
                <li><span class="l">Адмирал Борсалино (Мариджоа)</span></li>
                <li><span class="l">Адмирал Моддок (Маринфорд)</span></li>
                <li><span class="l">Адмирал Рёкугю (НМ)</span></li>
                </ul>
                Адмирал Флота
                <ul class="listing">
                <li><span class="l">Адмирал Сакадзуки (НМ)</span></li>
                </ul>
                Высокопоставленные дозорные
                <ul class="listing">
                <li><span class="l">Главный инспектор Сэнгоку</span></li>
                <li><span class="l">Инструктор Монки Д. Гарп</span></li>
                </ul>
