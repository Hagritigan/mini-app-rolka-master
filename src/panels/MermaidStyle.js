    ...
    <Panel id={id}>
        ...
        <Group>
            <Div>
                ...
                <ul class="listing">
                    <li><span class="l"><strong>Ultramarine (ウルトラマリン Уруторамарин?):</strong>&nbsp;Пользователь захватывает воду своими руками, похожими на Mizugokoro, а затем швыряет её вперед в мощном, чрезвычайно большом потоке, который разбрасывает противников с большой силой.</span></li>
                </ul>
